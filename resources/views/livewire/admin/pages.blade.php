<div class="space-y-6">
    ...
    <flux:modal name="page-editor-modal" class="max-w-5xl md:min-w-[48rem]!">
            ...
            <div class="space-y-4">
                @foreach ($blocks as $index => $block)
                    <div wire:key="content-block-{{ $index }}" class="rounded-lg border border-zinc-200 p-4 dark:border-zinc-700">
                        ...
                        <div class="mt-4 space-y-2 rounded-md bg-zinc-50 p-3 text-zinc-900 dark:bg-zinc-800/70 dark:text-zinc-100">
                            <flux:text class="text-xs uppercase tracking-wide text-zinc-500">{{ __('livePreview') }}</flux:text>
                            <div class="prose prose-sm max-w-none dark:prose-invert content-page-content bg-white p-4 rounded-md">
